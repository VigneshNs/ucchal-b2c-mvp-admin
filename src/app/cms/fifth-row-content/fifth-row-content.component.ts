...
import { FifthRowModel } from './fifth-row.model';
import { CmsService } from '../cms.service';
import { AppSetting } from '../../config/appSetting';
import { ProductDetails } from '../second-row-content/productDetails.model';

@Component({
  selector: 'app-fifth-row-content',
  templateUrl: './fifth-row-content.component.html',
  styleUrls: ['./fifth-row-content.component.css']
})
export class FifthRowContentComponent implements OnInit {
