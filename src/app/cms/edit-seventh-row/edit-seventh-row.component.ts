...
@Component({
  selector: 'app-edit-seventh-row',
  templateUrl: './edit-seventh-row.component.html',
  styleUrls: ['./edit-seventh-row.component.css']
})
export class EditSeventhRowComponent implements OnInit {
  ...
  getSeventhDetails() {
    this.cmsSerivce.getSingleSeventhProducts(this.id).subscribe(data => {
      console.log(data);
