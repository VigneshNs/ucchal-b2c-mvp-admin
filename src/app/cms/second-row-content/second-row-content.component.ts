...
import { SecondRowModel } from './second-row.model';
...
@Component({
  selector: 'app-second-row-content',
  templateUrl: './second-row-content.component.html',
  styleUrls: ['./second-row-content.component.css']
})
export class SecondRowContentComponent implements OnInit {
