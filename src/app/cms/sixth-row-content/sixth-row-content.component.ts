...
import { SixthRowModel } from './sixth-row.model';
...
@Component({
  selector: 'app-sixth-row-content',
  templateUrl: './sixth-row-content.component.html',
  styleUrls: ['./sixth-row-content.component.css']
})
export class SixthRowContentComponent implements OnInit {
