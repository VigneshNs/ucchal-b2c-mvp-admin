...
@Component({
  selector: 'app-add-flexible-coupon',
  templateUrl: './add-flexible-coupon.component.html',
  styleUrls: ['./add-flexible-coupon.component.css']
})
export class AddFlexibleCouponComponent implements OnInit {
  ...
  createDiscount(couponForm: FormGroup) {
    ...
    this.marketingService.createFlexibleCoupon(this.createHolder).subscribe(data => {
